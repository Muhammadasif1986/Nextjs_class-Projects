        ...
        <div className="flex flex-col justify-center items-center w-8/12 p-20">
          ...
          <div className="flex pl-10 text-xs font-black w-full h-auto">
            <ul className="flex items-center">
              ...
              <li className="pr-2 mr-2">
                Engine<span className="font-normal">660cc,</span>
              </li>
              <li className="pr-2 mr-2">
                Condition <span className="font-normal">9.5 / 10,</span>
              </li>
              <li className="pr-2 mr-2">
                Driven <span className="font-normal">3000 KM,</span>
              </li>
              <li className="pr-2 mr-2">
                Suspension Type{" "}
          ...
          <div className="flex pt-6 pl-10 text-xs font-black w-full h-auto">
            <ul className="flex items-center">
              <li className="mr-2">
                Avg <span className="font-normal pl-2">22 KM Per ltr,</span>
              </li>
              <li className="mr-2">
